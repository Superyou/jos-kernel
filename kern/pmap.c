...
mem_init_mp(void)
{
	...
	for(i=0;i<NCPU;i++)
	{
		...
		kstacktop_i = (uintptr_t)((char *)kstacktop_i - (KSTKGAP));
	}
...
page_remove(pde_t *pgdir, void *va)
{
	...
	if(page!=NULL)
	{
		...
		/*----Very important--- cant convert page to kva directly as pages later on gets
