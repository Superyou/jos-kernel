...
/*get buffer finds a empty buffer page in queue and returns start va of that page
and marks buse[i] = 1(marks it busy)*/
...
/* put buffer is triggered when the buffer page is used up i.e data might be transferred.
