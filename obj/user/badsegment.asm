...
libmain(int argc, char **argv)
{
  ...
  80004c:	e8 2f 01 00 00       	call   800180 <sys_getenvid>
...
exit(void)
{
  ...
  800089:	83 ec 18             	sub    $0x18,%esp
	close_all();
  80008c:	e8 19 06 00 00       	call   8006aa <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  800109:	00 
  80010a:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  800111:	00 
  800112:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800119:	00 
  80011a:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  800121:	e8 00 17 00 00       	call   801826 <_panic>
...
sys_env_cleanup(envid_t envid)
{
  ...
  80013c:	b8 04 00 00 00       	mov    $0x4,%eax
  ...
  80014e:	7e 28                	jle    800178 <sys_env_cleanup+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800150:	89 44 24 10          	mov    %eax,0x10(%esp)
  800154:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  80015b:	00 
  80015c:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  800163:	00 
  800164:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80016b:	00 
  80016c:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  800173:	e8 ae 16 00 00       	call   801826 <_panic>
...
sys_getenvid(void)
{
  ...
  800190:	89 d1                	mov    %edx,%ecx
  800192:	89 d3                	mov    %edx,%ebx
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001e0:	7e 28                	jle    80020a <sys_page_alloc+0x4c>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001e2:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001e6:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  8001ed:	00 
  8001ee:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  8001f5:	00 
  8001f6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001fd:	00 
  8001fe:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  800205:	e8 1c 16 00 00       	call   801826 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800229:	8b 7d 14             	mov    0x14(%ebp),%edi
  80022c:	8b 75 18             	mov    0x18(%ebp),%esi
  ...
  800233:	7e 28                	jle    80025d <sys_page_map+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800235:	89 44 24 10          	mov    %eax,0x10(%esp)
  800239:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  800240:	00 
  800241:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  800248:	00 
  800249:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800250:	00 
  800251:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  800258:	e8 c9 15 00 00       	call   801826 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800273:	b8 07 00 00 00       	mov    $0x7,%eax
  ...
  800286:	7e 28                	jle    8002b0 <sys_page_unmap+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800288:	89 44 24 10          	mov    %eax,0x10(%esp)
  80028c:	c7 44 24 0c 07 00 00 	movl   $0x7,0xc(%esp)
  800293:	00 
  800294:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  80029b:	00 
  80029c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002a3:	00 
  8002a4:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  8002ab:	e8 76 15 00 00       	call   801826 <_panic>
...
int sys_share_pages(envid_t dst_envid)
{
  ...
  8002c3:	b8 10 00 00 00       	mov    $0x10,%eax
  8002c8:	8b 55 08             	mov    0x8(%ebp),%edx
  8002cb:	89 cb                	mov    %ecx,%ebx
  8002cd:	89 cf                	mov    %ecx,%edi
  8002cf:	89 ce                	mov    %ecx,%esi
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002f9:	7e 28                	jle    800323 <sys_env_set_status+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002fb:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002ff:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  800306:	00 
  800307:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  80030e:	00 
  80030f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800316:	00 
  800317:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  80031e:	e8 03 15 00 00       	call   801826 <_panic>
...
0080032b <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  80034c:	7e 28                	jle    800376 <sys_env_set_trapframe+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80034e:	89 44 24 10          	mov    %eax,0x10(%esp)
  800352:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  800359:	00 
  80035a:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  800361:	00 
  800362:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800369:	00 
  80036a:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  800371:	e8 b0 14 00 00       	call   801826 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80039f:	7e 28                	jle    8003c9 <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003a1:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003a5:	c7 44 24 0c 0b 00 00 	movl   $0xb,0xc(%esp)
  8003ac:	00 
  8003ad:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  8003b4:	00 
  8003b5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003bc:	00 
  8003bd:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  8003c4:	e8 5d 14 00 00       	call   801826 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003dc:	b8 0d 00 00 00       	mov    $0xd,%eax
  8003e1:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  8003e4:	8b 55 08             	mov    0x8(%ebp),%edx
  8003e7:	8b 5d 10             	mov    0x10(%ebp),%ebx
  8003ea:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_ipc_recv(void *dstva)
{
  ...
  800402:	b8 0e 00 00 00       	mov    $0xe,%eax
  800407:	8b 55 08             	mov    0x8(%ebp),%edx
  80040a:	89 cb                	mov    %ecx,%ebx
  80040c:	89 cf                	mov    %ecx,%edi
  ...
  800414:	7e 28                	jle    80043e <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800416:	89 44 24 10          	mov    %eax,0x10(%esp)
  80041a:	c7 44 24 0c 0e 00 00 	movl   $0xe,0xc(%esp)
  800421:	00 
  800422:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  800429:	00 
  80042a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800431:	00 
  800432:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  800439:	e8 e8 13 00 00       	call   801826 <_panic>
...
sys_time_msec(void)
{
  ...
  800451:	b8 0f 00 00 00       	mov    $0xf,%eax
  800456:	89 d1                	mov    %edx,%ecx
  800458:	89 d3                	mov    %edx,%ebx
...
int sys_tx_packet(const char *data, size_t len)
{
  ...
  800470:	b8 11 00 00 00       	mov    $0x11,%eax
...
int sys_rx_packet(void *req, int *len)
{
  ...
  800491:	b8 12 00 00 00       	mov    $0x12,%eax
...
int sys_read_mac(uint8_t *data)
{
  ...
  8004b2:	b8 13 00 00 00       	mov    $0x13,%eax
...
int sys_read_mac(uint8_t *data)
{
  ...
  8004c5:	5d                   	pop    %ebp
  8004c6:	c3                   	ret    
  8004c7:	66 90                	xchg   %ax,%ax
  8004c9:	66 90                	xchg   %ax,%ax
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800669:	e8 f7 fb ff ff       	call   800265 <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800767:	e8 a6 fa ff ff       	call   800212 <sys_page_map>
  ...
  8007a2:	e8 6b fa ff ff       	call   800212 <sys_page_map>
...
err:
  ...
  8007bb:	e8 a5 fa ff ff       	call   800265 <sys_page_unmap>
	sys_page_unmap(0, nva);
  8007c0:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8007c4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8007cb:	e8 95 fa ff ff       	call   800265 <sys_page_unmap>
	return r;
...
alloc_sockfd(int sockid)
{
  ...
  800efc:	e8 bd f2 ff ff       	call   8001be <sys_page_alloc>
...
devpipe_close(struct Fd *fd)
{
  ...
  801360:	e8 00 ef ff ff       	call   800265 <sys_page_unmap>
  ...
  801378:	e8 e8 ee ff ff       	call   800265 <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801414:	75 41                	jne    801457 <devpipe_write+0x6b>
			...
			sys_yield();
  801416:	e8 84 ed ff ff       	call   80019f <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801494:	75 31                	jne    8014c7 <devpipe_read+0x63>
			...
			sys_yield();
  801496:	e8 04 ed ff ff       	call   80019f <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801507:	e8 b2 ec ff ff       	call   8001be <sys_page_alloc>
  ...
  801541:	e8 78 ec ff ff       	call   8001be <sys_page_alloc>
  ...
  801570:	e8 49 ec ff ff       	call   8001be <sys_page_alloc>
  ...
  8015a9:	e8 64 ec ff ff       	call   800212 <sys_page_map>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8016ed:	e8 ad e9 ff ff       	call   80009f <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801717:	eb 2a                	jmp    801743 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801719:	e8 81 ea ff ff       	call   80019f <sys_yield>
	int c;
  ...
  801720:	e8 98 e9 ff ff       	call   8000bd <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80175f:	e8 3b e9 ff ff       	call   80009f <sys_cputs>
}
  801764:	c9                   	leave  
  801765:	c3                   	ret    
...
opencons(void)
{
  ...
  8017f8:	e8 c1 e9 ff ff       	call   8001be <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801837:	e8 44 e9 ff ff       	call   800180 <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  8018a9:	e8 f1 e7 ff ff       	call   80009f <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801912:	e8 88 e7 ff ff       	call   80009f <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  80230e:	e8 e1 e0 ff ff       	call   8003f4 <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802386:	e8 46 e0 ff ff       	call   8003d1 <sys_ipc_try_send>
  ...
  8023ab:	e8 76 f4 ff ff       	call   801826 <_panic>
		...
		sys_yield();			
  8023b0:	e8 ea dd ff ff       	call   80019f <sys_yield>
	}
