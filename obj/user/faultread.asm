	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800248:	0f be 80 08 27 80 00 	movsbl 0x802708(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800322:	ff 24 95 40 28 80 00 	jmp    *0x802840(,%edx,4)
  ...
  8003eb:	c7 44 24 08 f2 2a 80 	movl   $0x802af2,0x8(%esp)
  8003f2:	00 
  ...
  80041e:	b8 19 27 80 00       	mov    $0x802719,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b80:	00 
  800b81:	c7 44 24 08 17 2a 80 	movl   $0x802a17,0x8(%esp)
  800b88:	00 
  800b89:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b90:	00 
  800b91:	c7 04 24 34 2a 80 00 	movl   $0x802a34,(%esp)
...
sys_env_cleanup(envid_t envid)
{
  ...
  800bd2:	00 
  800bd3:	c7 44 24 08 17 2a 80 	movl   $0x802a17,0x8(%esp)
  800bda:	00 
  800bdb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800be2:	00 
  800be3:	c7 04 24 34 2a 80 00 	movl   $0x802a34,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c64:	00 
  800c65:	c7 44 24 08 17 2a 80 	movl   $0x802a17,0x8(%esp)
  800c6c:	00 
  800c6d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c74:	00 
  800c75:	c7 04 24 34 2a 80 00 	movl   $0x802a34,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cb7:	00 
  800cb8:	c7 44 24 08 17 2a 80 	movl   $0x802a17,0x8(%esp)
  800cbf:	00 
  800cc0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cc7:	00 
  800cc8:	c7 04 24 34 2a 80 00 	movl   $0x802a34,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d0a:	00 
  800d0b:	c7 44 24 08 17 2a 80 	movl   $0x802a17,0x8(%esp)
  800d12:	00 
  800d13:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d1a:	00 
  800d1b:	c7 04 24 34 2a 80 00 	movl   $0x802a34,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d7d:	00 
  800d7e:	c7 44 24 08 17 2a 80 	movl   $0x802a17,0x8(%esp)
  800d85:	00 
  800d86:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d8d:	00 
  800d8e:	c7 04 24 34 2a 80 00 	movl   $0x802a34,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800dd0:	00 
  800dd1:	c7 44 24 08 17 2a 80 	movl   $0x802a17,0x8(%esp)
  800dd8:	00 
  800dd9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800de0:	00 
  800de1:	c7 04 24 34 2a 80 00 	movl   $0x802a34,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e23:	00 
  800e24:	c7 44 24 08 17 2a 80 	movl   $0x802a17,0x8(%esp)
  800e2b:	00 
  800e2c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e33:	00 
  800e34:	c7 04 24 34 2a 80 00 	movl   $0x802a34,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e98:	00 
  800e99:	c7 44 24 08 17 2a 80 	movl   $0x802a17,0x8(%esp)
  800ea0:	00 
  800ea1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ea8:	00 
  800ea9:	c7 04 24 34 2a 80 00 	movl   $0x802a34,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80102f:	8b 04 95 c0 2a 80 00 	mov    0x802ac0(,%edx,4),%eax
  ...
  80104a:	c7 04 24 44 2a 80 00 	movl   $0x802a44,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80129f:	c7 04 24 85 2a 80 00 	movl   $0x802a85,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801377:	c7 04 24 a1 2a 80 00 	movl   $0x802aa1,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801430:	c7 04 24 64 2a 80 00 	movl   $0x802a64,(%esp)
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  801677:	00 
  801678:	c7 04 24 d4 2a 80 00 	movl   $0x802ad4,(%esp)
  ...
  80169b:	c7 44 24 0c d9 2a 80 	movl   $0x802ad9,0xc(%esp)
  8016a2:	00 
  8016a3:	c7 44 24 08 e0 2a 80 	movl   $0x802ae0,0x8(%esp)
  8016aa:	00 
  8016ab:	c7 44 24 04 9d 00 00 	movl   $0x9d,0x4(%esp)
  8016b2:	00 
  8016b3:	c7 04 24 f5 2a 80 00 	movl   $0x802af5,(%esp)
  8016ba:	e8 d7 0b 00 00       	call   802296 <_panic>
	assert(r <= PGSIZE);
  8016bf:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8016c4:	7e 24                	jle    8016ea <devfile_write+0xba>
  8016c6:	c7 44 24 0c 00 2b 80 	movl   $0x802b00,0xc(%esp)
  8016cd:	00 
  8016ce:	c7 44 24 08 e0 2a 80 	movl   $0x802ae0,0x8(%esp)
  8016d5:	00 
  8016d6:	c7 44 24 04 9e 00 00 	movl   $0x9e,0x4(%esp)
  8016dd:	00 
  8016de:	c7 04 24 f5 2a 80 00 	movl   $0x802af5,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801725:	c7 44 24 0c d9 2a 80 	movl   $0x802ad9,0xc(%esp)
  80172c:	00 
  80172d:	c7 44 24 08 e0 2a 80 	movl   $0x802ae0,0x8(%esp)
  801734:	00 
  801735:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  80173c:	00 
  80173d:	c7 04 24 f5 2a 80 00 	movl   $0x802af5,(%esp)
  801744:	e8 4d 0b 00 00       	call   802296 <_panic>
	assert(r <= PGSIZE);
  801749:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80174e:	7e 24                	jle    801774 <devfile_read+0x84>
  801750:	c7 44 24 0c 00 2b 80 	movl   $0x802b00,0xc(%esp)
  801757:	00 
  801758:	c7 44 24 08 e0 2a 80 	movl   $0x802ae0,0x8(%esp)
  80175f:	00 
  801760:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  801767:	00 
  801768:	c7 04 24 f5 2a 80 00 	movl   $0x802af5,(%esp)
...
int evict(void)
{
  ...
  801835:	c7 04 24 0c 2b 80 00 	movl   $0x802b0c,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801866:	c7 44 24 04 25 2b 80 	movl   $0x802b25,0x4(%esp)
  80186d:	00 
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801c87:	c7 44 24 0c 31 2b 80 	movl   $0x802b31,0xc(%esp)
  801c8e:	00 
  801c8f:	c7 44 24 08 e0 2a 80 	movl   $0x802ae0,0x8(%esp)
  801c96:	00 
  801c97:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  801c9e:	00 
  801c9f:	c7 04 24 46 2b 80 00 	movl   $0x802b46,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801ce5:	c7 44 24 0c 52 2b 80 	movl   $0x802b52,0xc(%esp)
  801cec:	00 
  801ced:	c7 44 24 08 e0 2a 80 	movl   $0x802ae0,0x8(%esp)
  801cf4:	00 
  801cf5:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  801cfc:	00 
  801cfd:	c7 04 24 46 2b 80 00 	movl   $0x802b46,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801d80:	c7 44 24 04 5e 2b 80 	movl   $0x802b5e,0x4(%esp)
  801d87:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801e46:	c7 04 24 65 2b 80 00 	movl   $0x802b65,(%esp)
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  802100:	c7 44 24 04 7d 2b 80 	movl   $0x802b7d,0x4(%esp)
  802107:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8022c2:	c7 04 24 8c 2b 80 00 	movl   $0x802b8c,(%esp)
  ...
  8022d8:	e8 16 de ff ff       	call   8000f3 <vcprintf>
	cprintf("\n");
  8022dd:	c7 04 24 fc 26 80 00 	movl   $0x8026fc,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802394:	c7 44 24 08 b0 2b 80 	movl   $0x802bb0,0x8(%esp)
  80239b:	00 
  80239c:	c7 44 24 04 5a 00 00 	movl   $0x5a,0x4(%esp)
  8023a3:	00 
  8023a4:	c7 04 24 d4 2b 80 00 	movl   $0x802bd4,(%esp)
