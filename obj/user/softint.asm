...
libmain(int argc, char **argv)
{
  ...
  800048:	e8 2f 01 00 00       	call   80017c <sys_getenvid>
...
exit(void)
{
  ...
  800085:	83 ec 18             	sub    $0x18,%esp
	close_all();
  800088:	e8 1d 06 00 00       	call   8006aa <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  800105:	00 
  800106:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  80010d:	00 
  80010e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800115:	00 
  800116:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  80011d:	e8 04 17 00 00       	call   801826 <_panic>
...
sys_env_cleanup(envid_t envid)
{
  ...
  800138:	b8 04 00 00 00       	mov    $0x4,%eax
  ...
  80014a:	7e 28                	jle    800174 <sys_env_cleanup+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  80014c:	89 44 24 10          	mov    %eax,0x10(%esp)
  800150:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  800157:	00 
  800158:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  80015f:	00 
  800160:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800167:	00 
  800168:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  80016f:	e8 b2 16 00 00       	call   801826 <_panic>
...
sys_yield(void)
{
  ...
  8001a6:	b8 0c 00 00 00       	mov    $0xc,%eax
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001dc:	7e 28                	jle    800206 <sys_page_alloc+0x4c>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001de:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001e2:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  8001e9:	00 
  8001ea:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  8001f1:	00 
  8001f2:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8001f9:	00 
  8001fa:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  800201:	e8 20 16 00 00       	call   801826 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800222:	8b 5d 10             	mov    0x10(%ebp),%ebx
  800225:	8b 7d 14             	mov    0x14(%ebp),%edi
  800228:	8b 75 18             	mov    0x18(%ebp),%esi
  ...
  80022f:	7e 28                	jle    800259 <sys_page_map+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800231:	89 44 24 10          	mov    %eax,0x10(%esp)
  800235:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  80023c:	00 
  80023d:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  800244:	00 
  800245:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80024c:	00 
  80024d:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  800254:	e8 cd 15 00 00       	call   801826 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80026f:	b8 07 00 00 00       	mov    $0x7,%eax
  ...
  800282:	7e 28                	jle    8002ac <sys_page_unmap+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800284:	89 44 24 10          	mov    %eax,0x10(%esp)
  800288:	c7 44 24 0c 07 00 00 	movl   $0x7,0xc(%esp)
  80028f:	00 
  800290:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  800297:	00 
  800298:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80029f:	00 
  8002a0:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  8002a7:	e8 7a 15 00 00       	call   801826 <_panic>
...
int sys_share_pages(envid_t dst_envid)
{
  ...
  8002bf:	b8 10 00 00 00       	mov    $0x10,%eax
  8002c4:	8b 55 08             	mov    0x8(%ebp),%edx
  8002c7:	89 cb                	mov    %ecx,%ebx
  8002c9:	89 cf                	mov    %ecx,%edi
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002f5:	7e 28                	jle    80031f <sys_env_set_status+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002f7:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002fb:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  800302:	00 
  800303:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  80030a:	00 
  80030b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800312:	00 
  800313:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  80031a:	e8 07 15 00 00       	call   801826 <_panic>
...
00800327 <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800348:	7e 28                	jle    800372 <sys_env_set_trapframe+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80034a:	89 44 24 10          	mov    %eax,0x10(%esp)
  80034e:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  800355:	00 
  800356:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  80035d:	00 
  80035e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800365:	00 
  800366:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  80036d:	e8 b4 14 00 00       	call   801826 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800388:	b8 0b 00 00 00       	mov    $0xb,%eax
  ...
  80039b:	7e 28                	jle    8003c5 <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80039d:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003a1:	c7 44 24 0c 0b 00 00 	movl   $0xb,0xc(%esp)
  8003a8:	00 
  8003a9:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  8003b0:	00 
  8003b1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003b8:	00 
  8003b9:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  8003c0:	e8 61 14 00 00       	call   801826 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800406:	89 cb                	mov    %ecx,%ebx
  800408:	89 cf                	mov    %ecx,%edi
  80040a:	89 ce                	mov    %ecx,%esi
  ...
  800410:	7e 28                	jle    80043a <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800412:	89 44 24 10          	mov    %eax,0x10(%esp)
  800416:	c7 44 24 0c 0e 00 00 	movl   $0xe,0xc(%esp)
  80041d:	00 
  80041e:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  800425:	00 
  800426:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80042d:	00 
  80042e:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  800435:	e8 ec 13 00 00       	call   801826 <_panic>
...
sys_time_msec(void)
{
  ...
  80044d:	b8 0f 00 00 00       	mov    $0xf,%eax
...
int sys_rx_packet(void *req, int *len)
{
  ...
  80048d:	b8 12 00 00 00       	mov    $0x12,%eax
...
int sys_read_mac(uint8_t *data)
{
  ...
  8004c1:	5d                   	pop    %ebp
  8004c2:	c3                   	ret    
  8004c3:	66 90                	xchg   %ax,%ax
  8004c5:	66 90                	xchg   %ax,%ax
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800669:	e8 f3 fb ff ff       	call   800261 <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800767:	e8 a2 fa ff ff       	call   80020e <sys_page_map>
  ...
  8007a2:	e8 67 fa ff ff       	call   80020e <sys_page_map>
...
err:
  ...
  8007bb:	e8 a1 fa ff ff       	call   800261 <sys_page_unmap>
	sys_page_unmap(0, nva);
  8007c0:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8007c4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8007cb:	e8 91 fa ff ff       	call   800261 <sys_page_unmap>
	return r;
...
alloc_sockfd(int sockid)
{
  ...
  800efc:	e8 b9 f2 ff ff       	call   8001ba <sys_page_alloc>
...
devpipe_close(struct Fd *fd)
{
  ...
  801360:	e8 fc ee ff ff       	call   800261 <sys_page_unmap>
  ...
  801378:	e8 e4 ee ff ff       	call   800261 <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801414:	75 41                	jne    801457 <devpipe_write+0x6b>
			...
			sys_yield();
  801416:	e8 80 ed ff ff       	call   80019b <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801494:	75 31                	jne    8014c7 <devpipe_read+0x63>
			...
			sys_yield();
  801496:	e8 00 ed ff ff       	call   80019b <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801507:	e8 ae ec ff ff       	call   8001ba <sys_page_alloc>
  ...
  801541:	e8 74 ec ff ff       	call   8001ba <sys_page_alloc>
  ...
  801570:	e8 45 ec ff ff       	call   8001ba <sys_page_alloc>
  ...
  8015a9:	e8 60 ec ff ff       	call   80020e <sys_page_map>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8016ed:	e8 a9 e9 ff ff       	call   80009b <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801717:	eb 2a                	jmp    801743 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801719:	e8 7d ea ff ff       	call   80019b <sys_yield>
	int c;
  ...
  801720:	e8 94 e9 ff ff       	call   8000b9 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80175f:	e8 37 e9 ff ff       	call   80009b <sys_cputs>
}
  801764:	c9                   	leave  
  801765:	c3                   	ret    
...
opencons(void)
{
  ...
  8017f8:	e8 bd e9 ff ff       	call   8001ba <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801837:	e8 40 e9 ff ff       	call   80017c <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  8018a9:	e8 ed e7 ff ff       	call   80009b <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801912:	e8 84 e7 ff ff       	call   80009b <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  80230e:	e8 dd e0 ff ff       	call   8003f0 <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802386:	e8 42 e0 ff ff       	call   8003cd <sys_ipc_try_send>
  ...
  8023ab:	e8 76 f4 ff ff       	call   801826 <_panic>
		...
		sys_yield();			
  8023b0:	e8 e6 dd ff ff       	call   80019b <sys_yield>
	}
