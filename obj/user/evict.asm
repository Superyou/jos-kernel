...
obj/user/evict.debug:     file format elf32-i386
...
umain(int argc, char **argv)
{
  ...
  800039:	c7 04 24 e0 26 80 00 	movl   $0x8026e0,(%esp)
  800040:	e8 1b 01 00 00       	call   800160 <cprintf>
	block = evict();
  800045:	e8 f5 17 00 00       	call   80183f <evict>
	cprintf("\nFS evicted block:%d\n",block);
  80004a:	89 44 24 04          	mov    %eax,0x4(%esp)
  80004e:	c7 04 24 f9 26 80 00 	movl   $0x8026f9,(%esp)
  800055:	e8 06 01 00 00       	call   800160 <cprintf>
  80005a:	c9                   	leave  
  80005b:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  80006a:	e8 98 0b 00 00       	call   800c07 <sys_getenvid>
...
exit(void)
{
  ...
  8000a7:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000aa:	e8 7b 10 00 00       	call   80112a <close_all>
	sys_env_destroy(0);
  8000af:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000b6:	e8 a8 0a 00 00       	call   800b63 <sys_env_destroy>
}
  8000bb:	c9                   	leave  
  8000bc:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000da:	75 19                	jne    8000f5 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  8000dc:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  8000e3:	00 
  8000e4:	8d 43 08             	lea    0x8(%ebx),%eax
  8000e7:	89 04 24             	mov    %eax,(%esp)
  8000ea:	e8 37 0a 00 00       	call   800b26 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800134:	c7 04 24 bd 00 80 00 	movl   $0x8000bd,(%esp)
  80013b:	e8 74 01 00 00       	call   8002b4 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800153:	e8 ce 09 00 00       	call   800b26 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800258:	0f be 80 19 27 80 00 	movsbl 0x802719(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800332:	ff 24 95 60 28 80 00 	jmp    *0x802860(,%edx,4)
  ...
  8003fb:	c7 44 24 08 12 2b 80 	movl   $0x802b12,0x8(%esp)
  800402:	00 
  ...
  80042e:	b8 2a 27 80 00       	mov    $0x80272a,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b90:	00 
  800b91:	c7 44 24 08 37 2a 80 	movl   $0x802a37,0x8(%esp)
  800b98:	00 
  800b99:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ba0:	00 
  800ba1:	c7 04 24 54 2a 80 00 	movl   $0x802a54,(%esp)
...
sys_env_cleanup(envid_t envid)
{
  ...
  800be2:	00 
  800be3:	c7 44 24 08 37 2a 80 	movl   $0x802a37,0x8(%esp)
  800bea:	00 
  800beb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bf2:	00 
  800bf3:	c7 04 24 54 2a 80 00 	movl   $0x802a54,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c74:	00 
  800c75:	c7 44 24 08 37 2a 80 	movl   $0x802a37,0x8(%esp)
  800c7c:	00 
  800c7d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c84:	00 
  800c85:	c7 04 24 54 2a 80 00 	movl   $0x802a54,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cc7:	00 
  800cc8:	c7 44 24 08 37 2a 80 	movl   $0x802a37,0x8(%esp)
  800ccf:	00 
  800cd0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd7:	00 
  800cd8:	c7 04 24 54 2a 80 00 	movl   $0x802a54,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d1a:	00 
  800d1b:	c7 44 24 08 37 2a 80 	movl   $0x802a37,0x8(%esp)
  800d22:	00 
  800d23:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d2a:	00 
  800d2b:	c7 04 24 54 2a 80 00 	movl   $0x802a54,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d8d:	00 
  800d8e:	c7 44 24 08 37 2a 80 	movl   $0x802a37,0x8(%esp)
  800d95:	00 
  800d96:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d9d:	00 
  800d9e:	c7 04 24 54 2a 80 00 	movl   $0x802a54,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800de0:	00 
  800de1:	c7 44 24 08 37 2a 80 	movl   $0x802a37,0x8(%esp)
  800de8:	00 
  800de9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800df0:	00 
  800df1:	c7 04 24 54 2a 80 00 	movl   $0x802a54,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e33:	00 
  800e34:	c7 44 24 08 37 2a 80 	movl   $0x802a37,0x8(%esp)
  800e3b:	00 
  800e3c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e43:	00 
  800e44:	c7 04 24 54 2a 80 00 	movl   $0x802a54,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800ea8:	00 
  800ea9:	c7 44 24 08 37 2a 80 	movl   $0x802a37,0x8(%esp)
  800eb0:	00 
  800eb1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800eb8:	00 
  800eb9:	c7 04 24 54 2a 80 00 	movl   $0x802a54,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80103f:	8b 04 95 e0 2a 80 00 	mov    0x802ae0(,%edx,4),%eax
  ...
  80105a:	c7 04 24 64 2a 80 00 	movl   $0x802a64,(%esp)
  801061:	e8 fa f0 ff ff       	call   800160 <cprintf>
	*dev = 0;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80129f:	a1 08 40 80 00       	mov    0x804008,%eax
  8012a4:	8b 40 48             	mov    0x48(%eax),%eax
  8012a7:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  8012ab:	89 44 24 04          	mov    %eax,0x4(%esp)
  8012af:	c7 04 24 a5 2a 80 00 	movl   $0x802aa5,(%esp)
  8012b6:	e8 a5 ee ff ff       	call   800160 <cprintf>
		return -E_INVAL;
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801387:	c7 04 24 c1 2a 80 00 	movl   $0x802ac1,(%esp)
  80138e:	e8 cd ed ff ff       	call   800160 <cprintf>
		return -E_INVAL;
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801440:	c7 04 24 84 2a 80 00 	movl   $0x802a84,(%esp)
  801447:	e8 14 ed ff ff       	call   800160 <cprintf>
			thisenv->env_id, fdnum);
		return -E_INVAL;
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  801687:	00 
  801688:	c7 04 24 f4 2a 80 00 	movl   $0x802af4,(%esp)
  80168f:	e8 cc ea ff ff       	call   800160 <cprintf>
  ...
  8016ab:	c7 44 24 0c f9 2a 80 	movl   $0x802af9,0xc(%esp)
  8016b2:	00 
  8016b3:	c7 44 24 08 00 2b 80 	movl   $0x802b00,0x8(%esp)
  8016ba:	00 
  8016bb:	c7 44 24 04 9d 00 00 	movl   $0x9d,0x4(%esp)
  8016c2:	00 
  8016c3:	c7 04 24 15 2b 80 00 	movl   $0x802b15,(%esp)
  8016ca:	e8 d7 0b 00 00       	call   8022a6 <_panic>
	assert(r <= PGSIZE);
  8016cf:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8016d4:	7e 24                	jle    8016fa <devfile_write+0xba>
  8016d6:	c7 44 24 0c 20 2b 80 	movl   $0x802b20,0xc(%esp)
  8016dd:	00 
  8016de:	c7 44 24 08 00 2b 80 	movl   $0x802b00,0x8(%esp)
  8016e5:	00 
  8016e6:	c7 44 24 04 9e 00 00 	movl   $0x9e,0x4(%esp)
  8016ed:	00 
  8016ee:	c7 04 24 15 2b 80 00 	movl   $0x802b15,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801735:	c7 44 24 0c f9 2a 80 	movl   $0x802af9,0xc(%esp)
  80173c:	00 
  80173d:	c7 44 24 08 00 2b 80 	movl   $0x802b00,0x8(%esp)
  801744:	00 
  801745:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  80174c:	00 
  80174d:	c7 04 24 15 2b 80 00 	movl   $0x802b15,(%esp)
  801754:	e8 4d 0b 00 00       	call   8022a6 <_panic>
	assert(r <= PGSIZE);
  801759:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80175e:	7e 24                	jle    801784 <devfile_read+0x84>
  801760:	c7 44 24 0c 20 2b 80 	movl   $0x802b20,0xc(%esp)
  801767:	00 
  801768:	c7 44 24 08 00 2b 80 	movl   $0x802b00,0x8(%esp)
  80176f:	00 
  801770:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  801777:	00 
  801778:	c7 04 24 15 2b 80 00 	movl   $0x802b15,(%esp)
...
int evict(void)
{
  ...
  801845:	c7 04 24 2c 2b 80 00 	movl   $0x802b2c,(%esp)
  80184c:	e8 0f e9 ff ff       	call   800160 <cprintf>
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801876:	c7 44 24 04 45 2b 80 	movl   $0x802b45,0x4(%esp)
  80187d:	00 
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801c97:	c7 44 24 0c 51 2b 80 	movl   $0x802b51,0xc(%esp)
  801c9e:	00 
  801c9f:	c7 44 24 08 00 2b 80 	movl   $0x802b00,0x8(%esp)
  801ca6:	00 
  801ca7:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  801cae:	00 
  801caf:	c7 04 24 66 2b 80 00 	movl   $0x802b66,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801cf5:	c7 44 24 0c 72 2b 80 	movl   $0x802b72,0xc(%esp)
  801cfc:	00 
  801cfd:	c7 44 24 08 00 2b 80 	movl   $0x802b00,0x8(%esp)
  801d04:	00 
  801d05:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  801d0c:	00 
  801d0d:	c7 04 24 66 2b 80 00 	movl   $0x802b66,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801d90:	c7 44 24 04 7e 2b 80 	movl   $0x802b7e,0x4(%esp)
  801d97:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801e56:	c7 04 24 85 2b 80 00 	movl   $0x802b85,(%esp)
  801e5d:	e8 fe e2 ff ff       	call   800160 <cprintf>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  802110:	c7 44 24 04 9d 2b 80 	movl   $0x802b9d,0x4(%esp)
  802117:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8022d2:	c7 04 24 ac 2b 80 00 	movl   $0x802bac,(%esp)
  8022d9:	e8 82 de ff ff       	call   800160 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8022de:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  8022e2:	8b 45 10             	mov    0x10(%ebp),%eax
  8022e5:	89 04 24             	mov    %eax,(%esp)
  8022e8:	e8 12 de ff ff       	call   8000ff <vcprintf>
	cprintf("\n");
  8022ed:	c7 04 24 43 2b 80 00 	movl   $0x802b43,(%esp)
  8022f4:	e8 67 de ff ff       	call   800160 <cprintf>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8023a4:	c7 44 24 08 d0 2b 80 	movl   $0x802bd0,0x8(%esp)
  8023ab:	00 
  8023ac:	c7 44 24 04 5a 00 00 	movl   $0x5a,0x4(%esp)
  8023b3:	00 
  8023b4:	c7 04 24 f4 2b 80 00 	movl   $0x802bf4,(%esp)
