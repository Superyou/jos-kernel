...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 30 80 00 e0 	movl   $0x8026e0,0x803000
  800040:	26 80 00 
	...
	while (1) {
		sys_yield();
  800043:	e8 63 01 00 00       	call   8001ab <sys_yield>
...
libmain(int argc, char **argv)
{
  ...
  800058:	e8 2f 01 00 00       	call   80018c <sys_getenvid>
...
exit(void)
{
  ...
  800095:	83 ec 18             	sub    $0x18,%esp
	close_all();
  800098:	e8 1d 06 00 00       	call   8006ba <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  800115:	00 
  800116:	c7 44 24 08 ef 26 80 	movl   $0x8026ef,0x8(%esp)
  80011d:	00 
  80011e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800125:	00 
  800126:	c7 04 24 0c 27 80 00 	movl   $0x80270c,(%esp)
  80012d:	e8 04 17 00 00       	call   801836 <_panic>
...
sys_env_cleanup(envid_t envid)
{
  ...
  800148:	b8 04 00 00 00       	mov    $0x4,%eax
  80014d:	8b 55 08             	mov    0x8(%ebp),%edx
  800150:	89 cb                	mov    %ecx,%ebx
  800152:	89 cf                	mov    %ecx,%edi
  800154:	89 ce                	mov    %ecx,%esi
  ...
  80015a:	7e 28                	jle    800184 <sys_env_cleanup+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  80015c:	89 44 24 10          	mov    %eax,0x10(%esp)
  800160:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  800167:	00 
  800168:	c7 44 24 08 ef 26 80 	movl   $0x8026ef,0x8(%esp)
  80016f:	00 
  800170:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800177:	00 
  800178:	c7 04 24 0c 27 80 00 	movl   $0x80270c,(%esp)
  80017f:	e8 b2 16 00 00       	call   801836 <_panic>
...
sys_yield(void)
{
  ...
  8001b6:	b8 0c 00 00 00       	mov    $0xc,%eax
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001ec:	7e 28                	jle    800216 <sys_page_alloc+0x4c>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001ee:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001f2:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  8001f9:	00 
  8001fa:	c7 44 24 08 ef 26 80 	movl   $0x8026ef,0x8(%esp)
  800201:	00 
  800202:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800209:	00 
  80020a:	c7 04 24 0c 27 80 00 	movl   $0x80270c,(%esp)
  800211:	e8 20 16 00 00       	call   801836 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800232:	8b 5d 10             	mov    0x10(%ebp),%ebx
  800235:	8b 7d 14             	mov    0x14(%ebp),%edi
  800238:	8b 75 18             	mov    0x18(%ebp),%esi
  ...
  80023f:	7e 28                	jle    800269 <sys_page_map+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800241:	89 44 24 10          	mov    %eax,0x10(%esp)
  800245:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  80024c:	00 
  80024d:	c7 44 24 08 ef 26 80 	movl   $0x8026ef,0x8(%esp)
  800254:	00 
  800255:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80025c:	00 
  80025d:	c7 04 24 0c 27 80 00 	movl   $0x80270c,(%esp)
  800264:	e8 cd 15 00 00       	call   801836 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80027f:	b8 07 00 00 00       	mov    $0x7,%eax
  ...
  800292:	7e 28                	jle    8002bc <sys_page_unmap+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800294:	89 44 24 10          	mov    %eax,0x10(%esp)
  800298:	c7 44 24 0c 07 00 00 	movl   $0x7,0xc(%esp)
  80029f:	00 
  8002a0:	c7 44 24 08 ef 26 80 	movl   $0x8026ef,0x8(%esp)
  8002a7:	00 
  8002a8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002af:	00 
  8002b0:	c7 04 24 0c 27 80 00 	movl   $0x80270c,(%esp)
  8002b7:	e8 7a 15 00 00       	call   801836 <_panic>
...
int sys_share_pages(envid_t dst_envid)
{
  ...
  8002cf:	b8 10 00 00 00       	mov    $0x10,%eax
  8002d4:	8b 55 08             	mov    0x8(%ebp),%edx
  8002d7:	89 cb                	mov    %ecx,%ebx
  8002d9:	89 cf                	mov    %ecx,%edi
  8002db:	89 ce                	mov    %ecx,%esi
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800305:	7e 28                	jle    80032f <sys_env_set_status+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800307:	89 44 24 10          	mov    %eax,0x10(%esp)
  80030b:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  800312:	00 
  800313:	c7 44 24 08 ef 26 80 	movl   $0x8026ef,0x8(%esp)
  80031a:	00 
  80031b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800322:	00 
  800323:	c7 04 24 0c 27 80 00 	movl   $0x80270c,(%esp)
  80032a:	e8 07 15 00 00       	call   801836 <_panic>
...
00800337 <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800358:	7e 28                	jle    800382 <sys_env_set_trapframe+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80035a:	89 44 24 10          	mov    %eax,0x10(%esp)
  80035e:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  800365:	00 
  800366:	c7 44 24 08 ef 26 80 	movl   $0x8026ef,0x8(%esp)
  80036d:	00 
  80036e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800375:	00 
  800376:	c7 04 24 0c 27 80 00 	movl   $0x80270c,(%esp)
  80037d:	e8 b4 14 00 00       	call   801836 <_panic>
...
0080038a <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800398:	b8 0b 00 00 00       	mov    $0xb,%eax
  ...
  8003ab:	7e 28                	jle    8003d5 <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003ad:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003b1:	c7 44 24 0c 0b 00 00 	movl   $0xb,0xc(%esp)
  8003b8:	00 
  8003b9:	c7 44 24 08 ef 26 80 	movl   $0x8026ef,0x8(%esp)
  8003c0:	00 
  8003c1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003c8:	00 
  8003c9:	c7 04 24 0c 27 80 00 	movl   $0x80270c,(%esp)
  8003d0:	e8 61 14 00 00       	call   801836 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003e2:	53                   	push   %ebx
	...
	asm volatile("int %1\n"
  8003e3:	be 00 00 00 00       	mov    $0x0,%esi
  8003e8:	b8 0d 00 00 00       	mov    $0xd,%eax
  8003ed:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  8003f0:	8b 55 08             	mov    0x8(%ebp),%edx
  8003f3:	8b 5d 10             	mov    0x10(%ebp),%ebx
  8003f6:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_ipc_recv(void *dstva)
{
  ...
  80040e:	b8 0e 00 00 00       	mov    $0xe,%eax
  ...
  800420:	7e 28                	jle    80044a <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800422:	89 44 24 10          	mov    %eax,0x10(%esp)
  800426:	c7 44 24 0c 0e 00 00 	movl   $0xe,0xc(%esp)
  80042d:	00 
  80042e:	c7 44 24 08 ef 26 80 	movl   $0x8026ef,0x8(%esp)
  800435:	00 
  800436:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80043d:	00 
  80043e:	c7 04 24 0c 27 80 00 	movl   $0x80270c,(%esp)
  800445:	e8 ec 13 00 00       	call   801836 <_panic>
...
sys_time_msec(void)
{
  ...
  80045d:	b8 0f 00 00 00       	mov    $0xf,%eax
...
int sys_rx_packet(void *req, int *len)
{
  ...
  80049d:	b8 12 00 00 00       	mov    $0x12,%eax
...
int sys_read_mac(uint8_t *data)
{
  ...
  8004be:	b8 13 00 00 00       	mov    $0x13,%eax
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8005cf:	8b 04 95 98 27 80 00 	mov    0x802798(,%edx,4),%eax
  ...
  8005ea:	c7 04 24 1c 27 80 00 	movl   $0x80271c,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800679:	e8 f3 fb ff ff       	call   800271 <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800777:	e8 a2 fa ff ff       	call   80021e <sys_page_map>
  ...
  8007b2:	e8 67 fa ff ff       	call   80021e <sys_page_map>
...
err:
  ...
  8007cb:	e8 a1 fa ff ff       	call   800271 <sys_page_unmap>
	sys_page_unmap(0, nva);
  8007d0:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8007d4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8007db:	e8 91 fa ff ff       	call   800271 <sys_page_unmap>
	return r;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80083f:	c7 04 24 5d 27 80 00 	movl   $0x80275d,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800917:	c7 04 24 79 27 80 00 	movl   $0x802779,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8009d0:	c7 04 24 3c 27 80 00 	movl   $0x80273c,(%esp)
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  800c17:	00 
  800c18:	c7 04 24 ac 27 80 00 	movl   $0x8027ac,(%esp)
  ...
  800c3b:	c7 44 24 0c b1 27 80 	movl   $0x8027b1,0xc(%esp)
  800c42:	00 
  800c43:	c7 44 24 08 b8 27 80 	movl   $0x8027b8,0x8(%esp)
  800c4a:	00 
  800c4b:	c7 44 24 04 9d 00 00 	movl   $0x9d,0x4(%esp)
  800c52:	00 
  800c53:	c7 04 24 cd 27 80 00 	movl   $0x8027cd,(%esp)
  800c5a:	e8 d7 0b 00 00       	call   801836 <_panic>
	assert(r <= PGSIZE);
  800c5f:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800c64:	7e 24                	jle    800c8a <devfile_write+0xba>
  800c66:	c7 44 24 0c d8 27 80 	movl   $0x8027d8,0xc(%esp)
  800c6d:	00 
  800c6e:	c7 44 24 08 b8 27 80 	movl   $0x8027b8,0x8(%esp)
  800c75:	00 
  800c76:	c7 44 24 04 9e 00 00 	movl   $0x9e,0x4(%esp)
  800c7d:	00 
  800c7e:	c7 04 24 cd 27 80 00 	movl   $0x8027cd,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800cc5:	c7 44 24 0c b1 27 80 	movl   $0x8027b1,0xc(%esp)
  800ccc:	00 
  800ccd:	c7 44 24 08 b8 27 80 	movl   $0x8027b8,0x8(%esp)
  800cd4:	00 
  800cd5:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  800cdc:	00 
  800cdd:	c7 04 24 cd 27 80 00 	movl   $0x8027cd,(%esp)
  800ce4:	e8 4d 0b 00 00       	call   801836 <_panic>
	assert(r <= PGSIZE);
  800ce9:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800cee:	7e 24                	jle    800d14 <devfile_read+0x84>
  800cf0:	c7 44 24 0c d8 27 80 	movl   $0x8027d8,0xc(%esp)
  800cf7:	00 
  800cf8:	c7 44 24 08 b8 27 80 	movl   $0x8027b8,0x8(%esp)
  800cff:	00 
  800d00:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  800d07:	00 
  800d08:	c7 04 24 cd 27 80 00 	movl   $0x8027cd,(%esp)
...
int evict(void)
{
  ...
  800dd5:	c7 04 24 e4 27 80 00 	movl   $0x8027e4,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800e06:	c7 44 24 04 fd 27 80 	movl   $0x8027fd,0x4(%esp)
  800e0d:	00 
...
fd2sockid(int fd)
{
  ...
  800ec5:	8b 0d 20 30 80 00    	mov    0x803020,%ecx
...
alloc_sockfd(int sockid)
{
  ...
  800f0c:	e8 b9 f2 ff ff       	call   8001ca <sys_page_alloc>
  ...
  800f23:	8b 15 20 30 80 00    	mov    0x803020,%edx
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801227:	c7 44 24 0c 09 28 80 	movl   $0x802809,0xc(%esp)
  80122e:	00 
  80122f:	c7 44 24 08 b8 27 80 	movl   $0x8027b8,0x8(%esp)
  801236:	00 
  801237:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  80123e:	00 
  80123f:	c7 04 24 1e 28 80 00 	movl   $0x80281e,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801285:	c7 44 24 0c 2a 28 80 	movl   $0x80282a,0xc(%esp)
  80128c:	00 
  80128d:	c7 44 24 08 b8 27 80 	movl   $0x8027b8,0x8(%esp)
  801294:	00 
  801295:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  80129c:	00 
  80129d:	c7 04 24 1e 28 80 00 	movl   $0x80281e,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801320:	c7 44 24 04 36 28 80 	movl   $0x802836,0x4(%esp)
  801327:	00 
  ...
  801342:	00 00 00 
	stat->st_dev = &devpipe;
  801345:	c7 83 88 00 00 00 3c 	movl   $0x80303c,0x88(%ebx)
  80134c:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  801370:	e8 fc ee ff ff       	call   800271 <sys_page_unmap>
  ...
  801388:	e8 e4 ee ff ff       	call   800271 <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8013e6:	c7 04 24 3d 28 80 00 	movl   $0x80283d,(%esp)
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801424:	75 41                	jne    801467 <devpipe_write+0x6b>
			...
			sys_yield();
  801426:	e8 80 ed ff ff       	call   8001ab <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8014a4:	75 31                	jne    8014d7 <devpipe_read+0x63>
			...
			sys_yield();
  8014a6:	e8 00 ed ff ff       	call   8001ab <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801517:	e8 ae ec ff ff       	call   8001ca <sys_page_alloc>
  ...
  801551:	e8 74 ec ff ff       	call   8001ca <sys_page_alloc>
  ...
  801580:	e8 45 ec ff ff       	call   8001ca <sys_page_alloc>
  ...
  8015b9:	e8 60 ec ff ff       	call   80021e <sys_page_map>
  ...
  8015c4:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
  ...
  8015d9:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8016a0:	c7 44 24 04 55 28 80 	movl   $0x802855,0x4(%esp)
  8016a7:	00 
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8016fd:	e8 a9 e9 ff ff       	call   8000ab <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801727:	eb 2a                	jmp    801753 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801729:	e8 7d ea ff ff       	call   8001ab <sys_yield>
	int c;
  ...
  801730:	e8 94 e9 ff ff       	call   8000c9 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80176f:	e8 37 e9 ff ff       	call   8000ab <sys_cputs>
}
  801774:	c9                   	leave  
  801775:	c3                   	ret    
...
iscons(int fdnum)
{
  ...
  8017cb:	8b 15 58 30 80 00    	mov    0x803058,%edx
...
opencons(void)
{
  ...
  801808:	e8 bd e9 ff ff       	call   8001ca <sys_page_alloc>
		return r;
  ...
  801813:	8b 15 58 30 80 00    	mov    0x803058,%edx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801841:	8b 35 00 30 80 00    	mov    0x803000,%esi
  801847:	e8 40 e9 ff ff       	call   80018c <sys_getenvid>
  ...
  801862:	c7 04 24 64 28 80 00 	movl   $0x802864,(%esp)
  ...
  801878:	e8 51 00 00 00       	call   8018ce <vcprintf>
	cprintf("\n");
  80187d:	c7 04 24 fb 27 80 00 	movl   $0x8027fb,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8018b9:	e8 ed e7 ff ff       	call   8000ab <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801922:	e8 84 e7 ff ff       	call   8000ab <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801a28:	0f be 80 87 28 80 00 	movsbl 0x802887(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801b02:	ff 24 95 c0 29 80 00 	jmp    *0x8029c0(,%edx,4)
  ...
  801bcb:	c7 44 24 08 ca 27 80 	movl   $0x8027ca,0x8(%esp)
  801bd2:	00 
  ...
  801bfe:	b8 98 28 80 00       	mov    $0x802898,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  80231e:	e8 dd e0 ff ff       	call   800400 <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802396:	e8 42 e0 ff ff       	call   8003dd <sys_ipc_try_send>
  ...
  8023a4:	c7 44 24 08 98 2b 80 	movl   $0x802b98,0x8(%esp)
  8023ab:	00 
  8023ac:	c7 44 24 04 5a 00 00 	movl   $0x5a,0x4(%esp)
  8023b3:	00 
  8023b4:	c7 04 24 bc 2b 80 00 	movl   $0x802bbc,(%esp)
  8023bb:	e8 76 f4 ff ff       	call   801836 <_panic>
		}
		//cprintf("\nsend yielding:%x", thisenv->env_id);
		sys_yield();			
  8023c0:	e8 e6 dd ff ff       	call   8001ab <sys_yield>
	}
