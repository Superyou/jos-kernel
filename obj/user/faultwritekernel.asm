...
libmain(int argc, char **argv)
{
  ...
  800050:	e8 2f 01 00 00       	call   800184 <sys_getenvid>
...
exit(void)
{
  ...
  80008d:	83 ec 18             	sub    $0x18,%esp
	close_all();
  800090:	e8 15 06 00 00       	call   8006aa <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  80010d:	00 
  80010e:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  800115:	00 
  800116:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80011d:	00 
  80011e:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  800125:	e8 fc 16 00 00       	call   801826 <_panic>
...
sys_env_cleanup(envid_t envid)
{
  ...
  800140:	b8 04 00 00 00       	mov    $0x4,%eax
  ...
  800152:	7e 28                	jle    80017c <sys_env_cleanup+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800154:	89 44 24 10          	mov    %eax,0x10(%esp)
  800158:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  80015f:	00 
  800160:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  800167:	00 
  800168:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80016f:	00 
  800170:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  800177:	e8 aa 16 00 00       	call   801826 <_panic>
...
sys_yield(void)
{
  ...
  8001ae:	b8 0c 00 00 00       	mov    $0xc,%eax
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001e4:	7e 28                	jle    80020e <sys_page_alloc+0x4c>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001e6:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001ea:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  8001f1:	00 
  8001f2:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  8001f9:	00 
  8001fa:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800201:	00 
  800202:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  800209:	e8 18 16 00 00       	call   801826 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80022d:	8b 7d 14             	mov    0x14(%ebp),%edi
  800230:	8b 75 18             	mov    0x18(%ebp),%esi
  ...
  800237:	7e 28                	jle    800261 <sys_page_map+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800239:	89 44 24 10          	mov    %eax,0x10(%esp)
  80023d:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  800244:	00 
  800245:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  80024c:	00 
  80024d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800254:	00 
  800255:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  80025c:	e8 c5 15 00 00       	call   801826 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800277:	b8 07 00 00 00       	mov    $0x7,%eax
  ...
  80028a:	7e 28                	jle    8002b4 <sys_page_unmap+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80028c:	89 44 24 10          	mov    %eax,0x10(%esp)
  800290:	c7 44 24 0c 07 00 00 	movl   $0x7,0xc(%esp)
  800297:	00 
  800298:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  80029f:	00 
  8002a0:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002a7:	00 
  8002a8:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  8002af:	e8 72 15 00 00       	call   801826 <_panic>
...
int sys_share_pages(envid_t dst_envid)
{
  ...
  8002c7:	b8 10 00 00 00       	mov    $0x10,%eax
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002ea:	b8 09 00 00 00       	mov    $0x9,%eax
  ...
  8002fd:	7e 28                	jle    800327 <sys_env_set_status+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002ff:	89 44 24 10          	mov    %eax,0x10(%esp)
  800303:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  80030a:	00 
  80030b:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  800312:	00 
  800313:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80031a:	00 
  80031b:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  800322:	e8 ff 14 00 00       	call   801826 <_panic>
...
0080032f <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800350:	7e 28                	jle    80037a <sys_env_set_trapframe+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800352:	89 44 24 10          	mov    %eax,0x10(%esp)
  800356:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  80035d:	00 
  80035e:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  800365:	00 
  800366:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80036d:	00 
  80036e:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  800375:	e8 ac 14 00 00       	call   801826 <_panic>
...
00800382 <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800390:	b8 0b 00 00 00       	mov    $0xb,%eax
  ...
  8003a3:	7e 28                	jle    8003cd <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003a5:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003a9:	c7 44 24 0c 0b 00 00 	movl   $0xb,0xc(%esp)
  8003b0:	00 
  8003b1:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  8003b8:	00 
  8003b9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003c0:	00 
  8003c1:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  8003c8:	e8 59 14 00 00       	call   801826 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003e0:	b8 0d 00 00 00       	mov    $0xd,%eax
  8003e5:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  8003e8:	8b 55 08             	mov    0x8(%ebp),%edx
  8003eb:	8b 5d 10             	mov    0x10(%ebp),%ebx
  8003ee:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_ipc_recv(void *dstva)
{
  ...
  800418:	7e 28                	jle    800442 <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  80041a:	89 44 24 10          	mov    %eax,0x10(%esp)
  80041e:	c7 44 24 0c 0e 00 00 	movl   $0xe,0xc(%esp)
  800425:	00 
  800426:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  80042d:	00 
  80042e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800435:	00 
  800436:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  80043d:	e8 e4 13 00 00       	call   801826 <_panic>
...
int sys_tx_packet(const char *data, size_t len)
{
  ...
  800474:	b8 11 00 00 00       	mov    $0x11,%eax
...
int sys_rx_packet(void *req, int *len)
{
  ...
  800495:	b8 12 00 00 00       	mov    $0x12,%eax
...
int sys_read_mac(uint8_t *data)
{
  ...
  8004b6:	b8 13 00 00 00       	mov    $0x13,%eax
...
int sys_read_mac(uint8_t *data)
{
  ...
  8004c9:	5d                   	pop    %ebp
  8004ca:	c3                   	ret    
  8004cb:	66 90                	xchg   %ax,%ax
  8004cd:	66 90                	xchg   %ax,%ax
  8004cf:	90                   	nop
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800669:	e8 fb fb ff ff       	call   800269 <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800767:	e8 aa fa ff ff       	call   800216 <sys_page_map>
  ...
  8007a2:	e8 6f fa ff ff       	call   800216 <sys_page_map>
...
err:
  ...
  8007bb:	e8 a9 fa ff ff       	call   800269 <sys_page_unmap>
	sys_page_unmap(0, nva);
  8007c0:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8007c4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8007cb:	e8 99 fa ff ff       	call   800269 <sys_page_unmap>
	return r;
...
alloc_sockfd(int sockid)
{
  ...
  800efc:	e8 c1 f2 ff ff       	call   8001c2 <sys_page_alloc>
...
devpipe_close(struct Fd *fd)
{
  ...
  801360:	e8 04 ef ff ff       	call   800269 <sys_page_unmap>
  ...
  801378:	e8 ec ee ff ff       	call   800269 <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801414:	75 41                	jne    801457 <devpipe_write+0x6b>
			...
			sys_yield();
  801416:	e8 88 ed ff ff       	call   8001a3 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801494:	75 31                	jne    8014c7 <devpipe_read+0x63>
			...
			sys_yield();
  801496:	e8 08 ed ff ff       	call   8001a3 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801507:	e8 b6 ec ff ff       	call   8001c2 <sys_page_alloc>
  ...
  801541:	e8 7c ec ff ff       	call   8001c2 <sys_page_alloc>
  ...
  801570:	e8 4d ec ff ff       	call   8001c2 <sys_page_alloc>
  ...
  8015a9:	e8 68 ec ff ff       	call   800216 <sys_page_map>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8016ed:	e8 b1 e9 ff ff       	call   8000a3 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801717:	eb 2a                	jmp    801743 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801719:	e8 85 ea ff ff       	call   8001a3 <sys_yield>
	int c;
  ...
  801720:	e8 9c e9 ff ff       	call   8000c1 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80175f:	e8 3f e9 ff ff       	call   8000a3 <sys_cputs>
}
  801764:	c9                   	leave  
  801765:	c3                   	ret    
...
opencons(void)
{
  ...
  8017f8:	e8 c5 e9 ff ff       	call   8001c2 <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801837:	e8 48 e9 ff ff       	call   800184 <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  8018a9:	e8 f5 e7 ff ff       	call   8000a3 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801912:	e8 8c e7 ff ff       	call   8000a3 <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  80230e:	e8 e5 e0 ff ff       	call   8003f8 <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802386:	e8 4a e0 ff ff       	call   8003d5 <sys_ipc_try_send>
  ...
  8023ab:	e8 76 f4 ff ff       	call   801826 <_panic>
		...
		sys_yield();			
  8023b0:	e8 ee dd ff ff       	call   8001a3 <sys_yield>
	}
