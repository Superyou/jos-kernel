...
umain(int argc, char **argv)
{
  ...
  800051:	c7 04 24 ee 26 80 00 	movl   $0x8026ee,(%esp)
...
libmain(int argc, char **argv)
{
  ...
  80006d:	e8 95 0b 00 00       	call   800c07 <sys_getenvid>
...
exit(void)
{
  ...
  8000aa:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000ad:	e8 78 10 00 00       	call   80112a <close_all>
	sys_env_destroy(0);
  8000b2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000b9:	e8 a5 0a 00 00       	call   800b63 <sys_env_destroy>
}
  8000be:	c9                   	leave  
  8000bf:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000ed:	e8 34 0a 00 00       	call   800b26 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80013e:	e8 71 01 00 00       	call   8002b4 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800156:	e8 cb 09 00 00       	call   800b26 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800258:	0f be 80 0f 27 80 00 	movsbl 0x80270f(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003d5:	c7 44 24 08 27 27 80 	movl   $0x802727,0x8(%esp)
  8003dc:	00 
  ...
  80042e:	b8 20 27 80 00       	mov    $0x802720,%eax
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801061:	e8 fd f0 ff ff       	call   800163 <cprintf>
	*dev = 0;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8012b6:	e8 a8 ee ff ff       	call   800163 <cprintf>
		return -E_INVAL;
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80138e:	e8 d0 ed ff ff       	call   800163 <cprintf>
		return -E_INVAL;
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801447:	e8 17 ed ff ff       	call   800163 <cprintf>
			thisenv->env_id, fdnum);
		return -E_INVAL;
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  80168f:	e8 cf ea ff ff       	call   800163 <cprintf>
...
int evict(void)
{
  ...
  80184c:	e8 12 e9 ff ff       	call   800163 <cprintf>
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801e5d:	e8 01 e3 ff ff       	call   800163 <cprintf>
