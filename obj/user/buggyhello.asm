...
libmain(int argc, char **argv)
{
  ...
  80005d:	e8 2f 01 00 00       	call   800191 <sys_getenvid>
...
exit(void)
{
  ...
  80009a:	83 ec 18             	sub    $0x18,%esp
	close_all();
  80009d:	e8 18 06 00 00       	call   8006ba <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  80011a:	00 
  80011b:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  800122:	00 
  800123:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80012a:	00 
  80012b:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  800132:	e8 ff 16 00 00       	call   801836 <_panic>
...
sys_env_cleanup(envid_t envid)
{
  ...
  80015f:	7e 28                	jle    800189 <sys_env_cleanup+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800161:	89 44 24 10          	mov    %eax,0x10(%esp)
  800165:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  80016c:	00 
  80016d:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  800174:	00 
  800175:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80017c:	00 
  80017d:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  800184:	e8 ad 16 00 00       	call   801836 <_panic>
...
sys_yield(void)
{
  ...
  8001bb:	b8 0c 00 00 00       	mov    $0xc,%eax
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001f1:	7e 28                	jle    80021b <sys_page_alloc+0x4c>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001f3:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001f7:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  8001fe:	00 
  8001ff:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  800206:	00 
  800207:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80020e:	00 
  80020f:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  800216:	e8 1b 16 00 00       	call   801836 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800244:	7e 28                	jle    80026e <sys_page_map+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800246:	89 44 24 10          	mov    %eax,0x10(%esp)
  80024a:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  800251:	00 
  800252:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  800259:	00 
  80025a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800261:	00 
  800262:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  800269:	e8 c8 15 00 00       	call   801836 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800297:	7e 28                	jle    8002c1 <sys_page_unmap+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800299:	89 44 24 10          	mov    %eax,0x10(%esp)
  80029d:	c7 44 24 0c 07 00 00 	movl   $0x7,0xc(%esp)
  8002a4:	00 
  8002a5:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  8002ac:	00 
  8002ad:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002b4:	00 
  8002b5:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  8002bc:	e8 75 15 00 00       	call   801836 <_panic>
...
int sys_share_pages(envid_t dst_envid)
{
  ...
  8002d4:	b8 10 00 00 00       	mov    $0x10,%eax
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80030a:	7e 28                	jle    800334 <sys_env_set_status+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80030c:	89 44 24 10          	mov    %eax,0x10(%esp)
  800310:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  800317:	00 
  800318:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  80031f:	00 
  800320:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800327:	00 
  800328:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  80032f:	e8 02 15 00 00       	call   801836 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  80035d:	7e 28                	jle    800387 <sys_env_set_trapframe+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80035f:	89 44 24 10          	mov    %eax,0x10(%esp)
  800363:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  80036a:	00 
  80036b:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  800372:	00 
  800373:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80037a:	00 
  80037b:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  800382:	e8 af 14 00 00       	call   801836 <_panic>
...
0080038f <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8003b0:	7e 28                	jle    8003da <sys_env_set_pgfault_upcall+0x4b>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003b2:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003b6:	c7 44 24 0c 0b 00 00 	movl   $0xb,0xc(%esp)
  8003bd:	00 
  8003be:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  8003c5:	00 
  8003c6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003cd:	00 
  8003ce:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  8003d5:	e8 5c 14 00 00       	call   801836 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003ed:	b8 0d 00 00 00       	mov    $0xd,%eax
  8003f2:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  8003f5:	8b 55 08             	mov    0x8(%ebp),%edx
  8003f8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  8003fb:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_ipc_recv(void *dstva)
{
  ...
  800425:	7e 28                	jle    80044f <sys_ipc_recv+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800427:	89 44 24 10          	mov    %eax,0x10(%esp)
  80042b:	c7 44 24 0c 0e 00 00 	movl   $0xe,0xc(%esp)
  800432:	00 
  800433:	c7 44 24 08 ea 26 80 	movl   $0x8026ea,0x8(%esp)
  80043a:	00 
  80043b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800442:	00 
  800443:	c7 04 24 07 27 80 00 	movl   $0x802707,(%esp)
  80044a:	e8 e7 13 00 00       	call   801836 <_panic>
...
sys_time_msec(void)
{
  ...
  800462:	b8 0f 00 00 00       	mov    $0xf,%eax
  800467:	89 d1                	mov    %edx,%ecx
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8005cf:	8b 04 95 94 27 80 00 	mov    0x802794(,%edx,4),%eax
  ...
  8005ea:	c7 04 24 18 27 80 00 	movl   $0x802718,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800679:	e8 f8 fb ff ff       	call   800276 <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800777:	e8 a7 fa ff ff       	call   800223 <sys_page_map>
  ...
  8007b2:	e8 6c fa ff ff       	call   800223 <sys_page_map>
...
err:
  ...
  8007cb:	e8 a6 fa ff ff       	call   800276 <sys_page_unmap>
	sys_page_unmap(0, nva);
  8007d0:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8007d4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8007db:	e8 96 fa ff ff       	call   800276 <sys_page_unmap>
	return r;
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80083f:	c7 04 24 59 27 80 00 	movl   $0x802759,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800917:	c7 04 24 75 27 80 00 	movl   $0x802775,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8009d0:	c7 04 24 38 27 80 00 	movl   $0x802738,(%esp)
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  800c17:	00 
  800c18:	c7 04 24 a8 27 80 00 	movl   $0x8027a8,(%esp)
  ...
  800c3b:	c7 44 24 0c ad 27 80 	movl   $0x8027ad,0xc(%esp)
  800c42:	00 
  800c43:	c7 44 24 08 b4 27 80 	movl   $0x8027b4,0x8(%esp)
  800c4a:	00 
  800c4b:	c7 44 24 04 9d 00 00 	movl   $0x9d,0x4(%esp)
  800c52:	00 
  800c53:	c7 04 24 c9 27 80 00 	movl   $0x8027c9,(%esp)
  800c5a:	e8 d7 0b 00 00       	call   801836 <_panic>
	assert(r <= PGSIZE);
  800c5f:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800c64:	7e 24                	jle    800c8a <devfile_write+0xba>
  800c66:	c7 44 24 0c d4 27 80 	movl   $0x8027d4,0xc(%esp)
  800c6d:	00 
  800c6e:	c7 44 24 08 b4 27 80 	movl   $0x8027b4,0x8(%esp)
  800c75:	00 
  800c76:	c7 44 24 04 9e 00 00 	movl   $0x9e,0x4(%esp)
  800c7d:	00 
  800c7e:	c7 04 24 c9 27 80 00 	movl   $0x8027c9,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800cc5:	c7 44 24 0c ad 27 80 	movl   $0x8027ad,0xc(%esp)
  800ccc:	00 
  800ccd:	c7 44 24 08 b4 27 80 	movl   $0x8027b4,0x8(%esp)
  800cd4:	00 
  800cd5:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  800cdc:	00 
  800cdd:	c7 04 24 c9 27 80 00 	movl   $0x8027c9,(%esp)
  800ce4:	e8 4d 0b 00 00       	call   801836 <_panic>
	assert(r <= PGSIZE);
  800ce9:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800cee:	7e 24                	jle    800d14 <devfile_read+0x84>
  800cf0:	c7 44 24 0c d4 27 80 	movl   $0x8027d4,0xc(%esp)
  800cf7:	00 
  800cf8:	c7 44 24 08 b4 27 80 	movl   $0x8027b4,0x8(%esp)
  800cff:	00 
  800d00:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  800d07:	00 
  800d08:	c7 04 24 c9 27 80 00 	movl   $0x8027c9,(%esp)
...
int evict(void)
{
  ...
  800dd5:	c7 04 24 e0 27 80 00 	movl   $0x8027e0,(%esp)
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800e06:	c7 44 24 04 f9 27 80 	movl   $0x8027f9,0x4(%esp)
  800e0d:	00 
...
alloc_sockfd(int sockid)
{
  ...
  800f0c:	e8 be f2 ff ff       	call   8001cf <sys_page_alloc>
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801227:	c7 44 24 0c 05 28 80 	movl   $0x802805,0xc(%esp)
  80122e:	00 
  80122f:	c7 44 24 08 b4 27 80 	movl   $0x8027b4,0x8(%esp)
  801236:	00 
  801237:	c7 44 24 04 62 00 00 	movl   $0x62,0x4(%esp)
  80123e:	00 
  80123f:	c7 04 24 1a 28 80 00 	movl   $0x80281a,(%esp)
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801285:	c7 44 24 0c 26 28 80 	movl   $0x802826,0xc(%esp)
  80128c:	00 
  80128d:	c7 44 24 08 b4 27 80 	movl   $0x8027b4,0x8(%esp)
  801294:	00 
  801295:	c7 44 24 04 6d 00 00 	movl   $0x6d,0x4(%esp)
  80129c:	00 
  80129d:	c7 04 24 1a 28 80 00 	movl   $0x80281a,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801320:	c7 44 24 04 32 28 80 	movl   $0x802832,0x4(%esp)
  801327:	00 
...
devpipe_close(struct Fd *fd)
{
  ...
  801370:	e8 01 ef ff ff       	call   800276 <sys_page_unmap>
  ...
  801388:	e8 e9 ee ff ff       	call   800276 <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8013e6:	c7 04 24 39 28 80 00 	movl   $0x802839,(%esp)
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801424:	75 41                	jne    801467 <devpipe_write+0x6b>
			...
			sys_yield();
  801426:	e8 85 ed ff ff       	call   8001b0 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8014a4:	75 31                	jne    8014d7 <devpipe_read+0x63>
			...
			sys_yield();
  8014a6:	e8 05 ed ff ff       	call   8001b0 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801517:	e8 b3 ec ff ff       	call   8001cf <sys_page_alloc>
  ...
  801551:	e8 79 ec ff ff       	call   8001cf <sys_page_alloc>
  ...
  801580:	e8 4a ec ff ff       	call   8001cf <sys_page_alloc>
  ...
  8015b9:	e8 65 ec ff ff       	call   800223 <sys_page_map>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8016a0:	c7 44 24 04 51 28 80 	movl   $0x802851,0x4(%esp)
  8016a7:	00 
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8016fd:	e8 ae e9 ff ff       	call   8000b0 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801727:	eb 2a                	jmp    801753 <devcons_read+0x3d>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801729:	e8 82 ea ff ff       	call   8001b0 <sys_yield>
	int c;
  ...
  801730:	e8 99 e9 ff ff       	call   8000ce <sys_cgetc>
...
opencons(void)
{
  ...
  801808:	e8 c2 e9 ff ff       	call   8001cf <sys_page_alloc>
		return r;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801847:	e8 45 e9 ff ff       	call   800191 <sys_getenvid>
  ...
  801862:	c7 04 24 60 28 80 00 	movl   $0x802860,(%esp)
  ...
  801878:	e8 51 00 00 00       	call   8018ce <vcprintf>
	cprintf("\n");
  80187d:	c7 04 24 f7 27 80 00 	movl   $0x8027f7,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  8018b9:	e8 f2 e7 ff ff       	call   8000b0 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801922:	e8 89 e7 ff ff       	call   8000b0 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801a28:	0f be 80 83 28 80 00 	movsbl 0x802883(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801ba5:	c7 44 24 08 9b 28 80 	movl   $0x80289b,0x8(%esp)
  801bac:	00 
  ...
  801bcb:	c7 44 24 08 c6 27 80 	movl   $0x8027c6,0x8(%esp)
  801bd2:	00 
  ...
  801bfe:	b8 94 28 80 00       	mov    $0x802894,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  80231e:	e8 e2 e0 ff ff       	call   800405 <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802396:	e8 47 e0 ff ff       	call   8003e2 <sys_ipc_try_send>
  ...
  8023bb:	e8 76 f4 ff ff       	call   801836 <_panic>
		...
		sys_yield();			
  8023c0:	e8 eb dd ff ff       	call   8001b0 <sys_yield>
	}
